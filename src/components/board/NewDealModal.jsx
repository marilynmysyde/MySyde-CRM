...
const PLACEMENT_OPTIONS = [
  ...
  { value: 'premier_welcome',   label: 'Premier Welcome' },
  { value: 'start_screen',      label: 'Start Screen Sponsor' },
  { value: 'search_button',     label: 'Search Button' },
  { value: 'primary_wrap',      label: 'Primary Wrap' },
  { value: 'side_wrap',         label: 'Side Wrap' },
  { value: 'featured_event',    label: 'Featured Event' },
  { value: 'map_picture',       label: 'Map Picture Pin' },
  { value: 'map_name_under',    label: 'Map Name Under Pin' },
  { value: 'map_name_category', label: 'Map Name + Category' },
