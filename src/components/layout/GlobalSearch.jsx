...
const TYPE_CONFIG = {
  ...
  partner: { label: 'Partner', icon: '🤝', color: 'text-[#1D4ED8]' },
      ...
      <div className="relative bg-white rounded-xl shadow-2xl w-full max-w-lg mx-4 overflow-hidden">
        ...
        <div className="flex items-center gap-3 px-4 py-3 border-b border-gray-100">
          ...
          <input
            ...
            className="flex-1 text-sm text-[#111827] placeholder-gray-400 focus:outline-none"
            style={{ fontFamily: 'Manrope, sans-serif' }}
          />
          {loading && (
            <span className="text-xs text-gray-400 shrink-0" style={{ fontFamily: "'Manrope', sans-serif" }}>
              Searching…
            </span>
          )}
          <kbd
              ...
              return (
                <button
                  ...
                  className={`w-full flex items-center gap-3 px-4 py-2.5 text-left transition-colors ${
                    i === active ? 'bg-[#1D4ED8]/8' : 'hover:bg-gray-50'
                  }`}
                >
                  <span className="text-base shrink-0">{cfg.icon}</span>
                  <div className="flex-1 min-w-0">
                    <p
                      className="text-sm text-[#111827] truncate font-medium"
                      style={{ fontFamily: 'Manrope, sans-serif' }}
                    >
                      {r.label}
                    </p>
        ...
        {query.length >= 2 && results.length === 0 && !loading && (
          <div className="px-4 py-6 text-center text-sm text-gray-400" style={{ fontFamily: "'Manrope', sans-serif" }}>
        ...
        {query.length < 2 && (
          <div className="px-4 py-4">
            <p className="text-[10px] text-gray-400 uppercase tracking-wide mb-2" style={{ fontFamily: 'Manrope, sans-serif' }}>
              Jump to
            </p>
            <div className="flex gap-2 flex-wrap">
              {[
                ...
                <button
                  ...
                  className="text-xs bg-gray-100 hover:bg-[#1D4ED8]/10 text-gray-600 hover:text-[#1D4ED8] px-2.5 py-1 rounded-full transition-colors"
                  style={{ fontFamily: 'Manrope, sans-serif' }}
                >
                  {l.label}
                </button>
