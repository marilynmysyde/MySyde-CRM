...
export const PLACEMENTS = {
  ...
  community_static_slot: {
    ...
    category:      'digital',
    desc:          '4th static screen page — 5 slots per screen (10 total), free for City/Chamber/local orgs to promote events/programs. Rotates monthly (30-day cycle) per Marilyn 2026-09-03 — not a fixed multi-month hold. Track booking here so we know how many are still open on each screen.',
    exclusive:     false,
    defaultTerm:   1,
    termOptions:   [1],
    hasScreen:     true,
  ...
  search_button: {
    ...
    category:      'digital',
    desc:          'First-position button on search — 5 slots per screen (10 total)',
    exclusive:     false,
    defaultTerm:   3,
    termOptions:   [3],
    hasScreen:     true,
