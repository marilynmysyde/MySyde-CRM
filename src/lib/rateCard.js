...
export const PLACEMENTS = {
  ...
  community_static_slot: {
    ...
    category:      'digital',
    desc:          '4th static screen page — 5 slots per screen (10 total), free for City/Chamber/local orgs. Track booking here so we know how many are still open on each screen.',
    exclusive:     false,
    defaultTerm:   3,
    termOptions:   [3, 6, 12],
    hasScreen:     true,
